    ...
    <footer className='flexStart footer'>
        ...
        <div className='flex items-start flex-col'>
            ...
            <p className='text-start text-sm font-normal mt-5 max-w-xs'>
                Flexxible is the world ledaing comasdma for caera share goraw ad n asdmag.
            </p>
          </div>  
        ...
        <div className='flexBetween footer_copyright'>
            <p>@ 2023 Flexxibble. All rights reserved </p>
            <p className='text-gray'>
                <span className='text-black font-semibold'>10,214</span> projects subbmited.
            </p>
        </div>
    </footer>
  )
